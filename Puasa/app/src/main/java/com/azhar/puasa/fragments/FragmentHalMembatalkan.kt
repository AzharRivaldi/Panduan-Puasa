...
class FragmentHalMembatalkan : Fragment() {
    ...
    private fun loadJSON() {
        try {
            ...
            try {
                ...
                val jsonObjectTwo = jsonObjectOne.getJSONObject("yang_membatalkan")
                val HalYangMembatalkan = jsonObjectTwo.getString("description")
                webviewDetail?.loadData(HalYangMembatalkan, "text/html; charset=utf-8", "UTF-8")
