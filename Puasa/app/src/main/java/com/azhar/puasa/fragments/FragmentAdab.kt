    ...
    private fun loadJSON() {
        try {
            ...
            try {
                ...
                val jsonObjectTwo = jsonObjectOne.getJSONObject("adab_adab")
                val AdabPuasa = jsonObjectTwo.getString("description")
                webviewDetail?.loadData(AdabPuasa, "text/html; charset=utf-8", "UTF-8")
